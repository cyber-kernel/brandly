...
const plans = [
  {
    name: 'Starter',
    description: 'Perfect for getting started with core digital engines',
    monthlyPrice: 0,
    yearlyPrice: 0,
    features: [
      'Access to core API modules',
  ...
  {
    name: 'Professional',
    description: 'For businesses that need advanced systems and high scale',
    monthlyPrice: 99,
    yearlyPrice: 79,
    features: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Start with our core engine or upgrade to Professional for advanced systems and enterprise features.
          </p>
