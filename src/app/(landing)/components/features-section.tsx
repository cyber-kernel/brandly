...
const mainFeatures = [
  {
    ...
    description: 'Scalable and robust digital engines for high-performance applications.'
  },
  {
    icon: Crown,
  ...
  },
  {
    ...
    description: 'Flexible and pluggable components that adapt to your needs.'
  },
  {
    icon: Zap,
    title: 'Instant Deployment',
    description: 'Streamlined pipelines for rapid and reliable system updates.'
  }
]
    ...
    <section id="features" className="py-24 sm:py-32 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center mb-16">
          <Badge variant="outline" className="mb-4">Core Solutions</Badge>
