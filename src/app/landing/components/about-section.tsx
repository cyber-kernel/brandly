      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            We&apos;re passionate about creating high-performance digital architectures and modern system interfaces.
            Our mission is to accelerate digital transformation and help teams build powerful software faster.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="flex items-center justify-center gap-2 mb-6">
            <span className="text-muted-foreground">Empowering digital innovation across the globe.</span>
          </div>
